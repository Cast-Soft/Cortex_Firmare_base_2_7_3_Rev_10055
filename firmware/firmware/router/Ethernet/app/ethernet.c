...
void MsgLoop(StatusType result, void *msg) {
    ...
    {
      SAVE_POINT
        if ((diagnostic.acceptEtherTxDone = CoAcceptSingleFlag(flagEtherTxDone)) == E_OK) {
...
void RX_Pkt_Handler(void) {
    ...
    if (diagnostic.postEthernetRcvd == E_OK) {
