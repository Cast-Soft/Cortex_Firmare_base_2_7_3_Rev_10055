...
/* GPI_RADIO_GPIO0, GPI_RADIO_GPIO1, GPI_RADIO_GPIO2, GPI_MS_SYNC */
      GPIO_TypeDef*     GPI_PORT[] = {GPI_RADIO_GPIO0_PORT, GPI_RADIO_GPIO1_PORT, GPI_RADIO_GPIO2_PORT, GPI_MS_SYNC_PORT, GPI_AtoDin6_PORT, GPO_TP49_PORT,GPI_RADIO_GPIO5_PORT};
const uint32_t          GPI_CLK[] =  {GPI_RADIO_GPIO0_CLK, GPI_RADIO_GPIO1_CLK, GPI_RADIO_GPIO2_CLK, GPI_MS_SYNC_CLK, GPI_AtoDin6_CLK, GPO_TP49_CLK,GPI_RADIO_GPIO5_CLK};
const uint16_t          GPI_PIN[] =  {GPI_RADIO_GPIO0_PIN, GPI_RADIO_GPIO1_PIN, GPI_RADIO_GPIO2_PIN, GPI_MS_SYNC_PIN, GPI_AtoDin6_PIN, GPO_TP49_PIN, GPI_RADIO_GPIO5_PIN};
const GPIOMode_TypeDef  GPI_TYPE[] = {GPI_RADIO_GPIO0_TYPE, GPI_RADIO_GPIO1_TYPE, GPI_RADIO_GPIO2_TYPE, GPI_MS_SYNC_TYPE, GPI_AtoDin6_TYPE, GPI_TP49_PIN_TYPE, GPI_RADIO_GPIO5_TYPE};
...
void HwPeriphInit(void) {
    ...
    // TODO!!! GPIO5 available. Not being used by router
...
void HwRadioEXTIInit(void) {
    ...
    /* Configure GPI_RADIO_GPIO1(PD.1)=>(RX_OVERFLOW | RX_UNDERFLOW) as EXTI Interrupt */
