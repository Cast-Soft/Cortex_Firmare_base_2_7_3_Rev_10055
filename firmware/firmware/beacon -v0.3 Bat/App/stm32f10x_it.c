...
void hard_fault_handler_c(unsigned int * hardfault_args)
{
  ...
  //requires I2C line to be free at this given moment
  //reset the line?
...
//#if 0
      ...
      // -- Button state process
//#endif
    /*if(BATData_counter<100) BATData_counter++
    else ISR_SETFlag(flagBatDataGet); */
...
void I2Cx_EV_IRQHandler(void){
  ENTER_ISR();
  switch(I2C_GetLastEvent(I2C_EE)){
    ...
    //check write or read mode.
      ...
      else{ //I2CTxRxByteState is in INIT or unknown state. Something has went wrong.
        //turn off the I2C comms.
        assert(0);
        I2C_ERR=1;
        I2CTxRxByteCount = 0;
        I2CTxRxByteState = I2C_INIT_MODE;
...
/* Master Receiver ------------------------------------------------------------*/
    ...
    case I2C_EVENT_MASTER_BYTE_RECEIVED:                                  //EV7
      *(pI2CTxBuf++) = I2C_ReceiveData(I2C_EE);
      I2CTxRxByteCount--;
      if(I2CTxRxByteCount==0){
       I2CTxRxByteState = I2C_INIT_MODE;
...
/* Master Transmitter --------------------------------------------------------*/
    ...
    case I2C_EVENT_MASTER_BYTE_TRANSMITTED:                               //EV8_2
      ...
      break;
    default:
      //something wrong has occurred. Turn off interrupts and clear flags.
      assert(0);
      I2C_ERR=1;
      I2CTxRxByteCount = 0;
      I2CTxRxByteState = I2C_INIT_MODE;
