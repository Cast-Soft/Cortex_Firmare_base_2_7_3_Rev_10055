...
typedef enum
{
    ...
    GPO_IRLED2 = 4, 		//swapped with GPO_IRLED1
    //GPO_TP6 = 5,			//TP6
    //GPO_TP7 = 6,			//TP7
    //GPO_TP10 = 7,			//TP10
    GPO_2520_RST=5,			
...
#define GPI_INK_BUSY_PIN           GPIO_Pin_13 //12
#define GPI_INK_BUSY_TYPE          GPIO_Mode_IN_FLOATING//GPIO_Mode_IPU

#define GPI_INK_PORT_SRC       	    GPIO_PortSourceGPIOD
#define GPI_INK_PIN_SRC        	    GPIO_PinSource13
#define GPI_INK_EXTI_LINE      	    EXTI_Line13
#define GPI_INK_IRQn           	    EXTI15_10_IRQn
/* GPI_IRLED_DAC */
...
/*GPI AtoD input */
#define GPI_VBAT_ADC_PORT           GPIOA
#define GPI_VBAT_ADC_CLK            RCC_APB2Periph_GPIOA
#define GPI_VBAT_ADC_PIN            GPIO_Pin_6
...
/* GPI_BAT_INT */
#define GPI_BAT_INT_PORT             GPIOE
#define GPI_BAT_INT_CLK              RCC_APB2Periph_GPIOE
#define GPI_BAT_INT_PIN              GPIO_Pin_2
#define GPI_BAT_INT_TYPE             GPIO_Mode_IN_FLOATING
...
/* GPO_IRLED0 */
#define GPO_IRLED0_PORT             GPIOE                   //GPIOB
#define GPO_IRLED0_CLK              RCC_APB2Periph_GPIOE    //RCC_APB2Periph_GPIOB
#define GPO_IRLED0_PIN              GPIO_Pin_12             //GPIO_Pin_0
...
/* GPO_IRLED2 */
#define GPO_IRLED2_PORT             GPIOB                   //GPIOE
#define GPO_IRLED2_CLK              RCC_APB2Periph_GPIOB    //RCC_APB2Periph_GPIOE
#define GPO_IRLED2_PIN              GPIO_Pin_0              //GPIO_Pin_12
...
#define GPO_INK_RST_CLK            RCC_APB2Periph_GPIOD
...
/* BUTTON */
/**********/
//reverse the button 1 and 2 assignments on schematic to fit CAST request 
/* BUTTON1 */
#define BUTTON1_PORT                GPIOB                   //GPIOA
#define BUTTON1_CLK                 RCC_APB2Periph_GPIOB    //RCC_APB2Periph_GPIOA
#define BUTTON1_PIN                 GPIO_Pin_11             //GPIO_Pin_1

/* BUTTON2 */
#define BUTTON2_PORT                GPIOA                   //GPIOB
#define BUTTON2_CLK                 RCC_APB2Periph_GPIOA    //RCC_APB2Periph_GPIOB
#define BUTTON2_PIN                 GPIO_Pin_1              //GPIO_Pin_11
...
#define SPI_INK_TX_DMA_IRQ          DMA1_Channel5_IRQn
...
extern Batt_Union_t BattUnion;

#define TIM_AUTORELOAD          59999
#define TIM3_AUTORELOAD         59999
