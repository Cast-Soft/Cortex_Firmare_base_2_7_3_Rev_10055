...
#define FLAG_TRACE_LEDSHUNTSYNC                 0x8000
#define FLAG_TRACE_UI_STATEMACHINE              0x10000
...
//  from config_t without checksum and u32IwdgResetEvents;
  ...
  uint8_t       BTN_dblclick_val;
  uint8_t       BTN_hold_val;
  uint8_t       chgstate_radio_en;
  uint8_t       dummyPad;
...
typedef struct{
  uint8_t ChgCycleCurrent;
  uint16_t ChgCycleTotal;
}chargecycle_t;
