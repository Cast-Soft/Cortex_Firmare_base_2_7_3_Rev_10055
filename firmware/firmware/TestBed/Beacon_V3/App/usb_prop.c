...
// TESt for endpoints 5 and 7    
       /* Init EP5OUT as Bulk endpoint */
//  OTG_DEV_EP_Init(EP5_OUT, OTG_DEV_EP_TYPE_BULK, VIRTUAL_COM_PORT_DATA_SIZE);
       /* Init EP7 IN as Bulk endpoint */
//    OTG_DEV_EP_Init(EP7_IN, OTG_DEV_EP_TYPE_BULK, VIRTUAL_COM_PORT_DATA_SIZE);
