...
//      0x47, 0x05,                 /* idVendor = 0x0547 */ // Cypress ezusb
//      0x35, 0x22,                 /* idProduct = 0x2235 */ // no eeprom
...
const uint8_t Virtual_Com_Port_StringProduct[VIRTUAL_COM_PORT_SIZ_STRING_PRODUCT] =
    ...
    USB_STRING_DESCRIPTOR_TYPE,              /* bDescriptorType */
    /* Product name: "BlackTrax-BC COM Port" */
            'B', 0, 'l', 0, 'a', 0, 'c', 0, 'k', 0, 'T', 0, 'r', 0, 'a', 0, 'x', 0, '-', 0, 'B', 0,
            'C', 0, ' ', 0, 'C', 0, 'O', 0, 'M', 0, ' ', 0, 'P', 0, 'o', 0, 'r', 0, 't', 0
    };
