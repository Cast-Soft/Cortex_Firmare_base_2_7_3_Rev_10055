...
#ifdef TASKS_PROFILE
extern U32         CoGetTaskScheduledCount(OS_TID taskID);
extern U16         CoGetTaskLine(OS_TID taskID);
extern const char* CoGetTaskFunc(OS_TID taskID);
extern U32         CoGetStackDepth(OS_TID taskID);
extern OS_TID      CoGetCurrentTaskId();
#endif
...
extern StatusType  isr_PostQueueMailWithWaterMark(OS_EventID id,void* pmail);
