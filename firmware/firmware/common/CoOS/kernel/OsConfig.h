...
*/
#define CFG_SYSTICK_FREQ            (/*100*/1000)

/*!<
max systerm api call num in ISR.
*/
#define CFG_MAX_SERVICE_REQUEST         (12) // Increased - had problems in router - SPI stack(5)
#define CFG_MAX_SERVICE_WATERMARK        (CFG_MAX_SERVICE_REQUEST - 4)
...
*/
#define CFG_STK_CHECKOUT_EN         (1) //(0)
...
*/
#if CFG_KHEAP_EN >0
#define KHEAP_SIZE                  (2560)          // 10K bytes
#endif
