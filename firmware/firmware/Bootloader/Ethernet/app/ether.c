...
static void GPIO_init(uint16_t GPIO_Pin, GPIOMode_TypeDef GPIO_Mode,
                      GPIO_TypeDef *GPIOx)
{
...
int EthernetInit(void)
{
...
#endif
  GPIO_init(GPIO_Pin_2, GPIO_Mode_AF_PP, GPIOA);
  GPIO_init(GPIO_Pin_1, GPIO_Mode_AF_PP, GPIOC);
  GPIO_init(GPIO_Pin_11 | GPIO_Pin_12 | GPIO_Pin_13, GPIO_Mode_AF_PP, GPIOB);
...
#endif
  GPIO_init( GPIO_Pin_8 | GPIO_Pin_9 | GPIO_Pin_10, GPIO_Mode_IN_FLOATING, GPIOD);
  
#else  
  GPIO_PinRemapConfig(GPIO_Remap_ETH, DISABLE);

  /* Configure PA0, PA1 and PA3 as input */
  GPIO_init( GPIO_Pin_0 | GPIO_Pin_1 | GPIO_Pin_7, GPIO_Mode_IN_FLOATING, GPIOA);

  /* Configure PB10 as input */
  GPIO_init( GPIO_Pin_10, GPIO_Mode_IN_FLOATING, GPIOB);

  /* Configure PC3 as input */
  GPIO_init( GPIO_Pin_3 | GPIO_Pin_4 | GPIO_Pin_5, GPIO_Mode_IN_FLOATING, GPIOC);
  ...
  GPIO_init( GPIO_Pin_8, GPIO_Mode_AF_PP, GPIOA);
...
//  TK SMSC 8710A
  ...
  {
#ifdef STM3210C_EVAL    
    if((0x2000 == ETH_ReadPHYRegister(PhyAddr,2))
				&& (0x5c90 == (ETH_ReadPHYRegister(PhyAddr,3)))) break;
#else
