...
void USB_OTG_DisableCommonInt(USB_OTG_CORE_HANDLE *pdev)
{
  /* Clear any pending USB_OTG Interrupts */
#ifndef USE_OTG_MODE
  USB_OTG_WRITE_REG32( &pdev->regs.GREGS->GOTGINT, 0x0);
#endif
  /* Clear any pending interrupts */
  USB_OTG_WRITE_REG32( &pdev->regs.GREGS->GINTSTS, 0x0);
  USB_OTG_WRITE_REG32( &pdev->regs.GREGS->GINTMSK, 0x0);
}
