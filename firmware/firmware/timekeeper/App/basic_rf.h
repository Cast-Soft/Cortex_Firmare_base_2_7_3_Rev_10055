...
#define             RF_CHANNEL_MAX          26
#define             RF_CHANNEL_MIN          11
#define             OLD_RF_CHANNEL_MAX          21
#define             OLD_RF_CHANNEL_MIN          9

#define             NUM_RF_CHANNELS (1 + RF_CHANNEL_MAX - RF_CHANNEL_MIN)
// Number of frames for each channel to shift
#define CHANNEL_FRAME_SHIFT     5 //(100/NUM_RF_CHANNELS)//7
...
extern volatile uint16_t txFIFOError;       // 0: no error, 1: with error
extern OS_FlagID flagSPIMachineDone;        // When SPI state machine is rolling, tasks should wait it finish to get control
