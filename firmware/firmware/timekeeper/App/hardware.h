...
/*GPI USB_POWER_SENSOR */
#define GPI_USB_POWER_SENSOR_PORT          GPIOA
#define GPI_USB_POWER_SENSOR_CLK           RCC_APB2Periph_GPIOA
#define GPI_USB_POWER_SENSOR_PIN           GPIO_Pin_9
#define GPI_USB_POWER_SENSOR_TYPE          GPIO_Mode_IN_FLOATING
